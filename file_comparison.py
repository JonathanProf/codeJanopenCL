...
# Labels Comparison
f1 = np.fromfile( _path + 'labelsBindsnetOut.csv', dtype = np.int8 ,sep='\n')
f2 = np.fromfile( _path + 'labelsVIM3Paralelo.csv', dtype = np.int8 ,sep='\n')
f3 = np.fromfile( _path + 'labelsBindsnetIn.csv', dtype = np.int8 ,sep='\n')
cmp2 = 0
cmp1 = 0
